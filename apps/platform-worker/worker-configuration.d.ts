/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/platform-worker/wrangler.jsonc apps/platform-worker/worker-configuration.d.ts` (hash: c9486d5285beb8e9ccd1ab0a3d95d26e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "PUBLIC_APP_URL" | "NPM_PACKAGE_NAME" | "GITHUB_REPOSITORY_URL">> {}
}
